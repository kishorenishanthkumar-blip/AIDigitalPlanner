...
(function () {
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (gPending) {
      const map = { h:'home.html', n:'nishi-chatbot.html', d:'discovery-studio.html', a:'architecture-studio.html', e:'evp-summary.html', s:'sow.html', g:'program-governance.html', q:'questionnaire.html', o:'operations.html' };
